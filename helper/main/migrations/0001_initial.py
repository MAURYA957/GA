# Generated by Django 4.0.5 on 2024-04-19 11:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_profile', models.ImageField(blank=True, upload_to='users/%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('slug', models.SlugField(max_length=200, unique=True)),
                ('sop_type', models.CharField(max_length=100)),
                ('document', models.ImageField(blank=True, upload_to='Documents/KB/SOP')),
                ('created_on', models.DateTimeField()),
                ('drone_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.productmodel')),
                ('user_types', models.ManyToManyField(to='main.usertype')),
            ],
        ),
        migrations.CreateModel(
            name='ECN',
